...
class AdRequest(db.Model):
    ...
    influencer = db.relationship('User', foreign_keys=[influencer_id], backref=db.backref('influencer_ad_requests', lazy=True))
    sponsor = db.relationship('User', foreign_keys=[sponsor_id], backref=db.backref('sponsor_ad_requests', lazy=True))
